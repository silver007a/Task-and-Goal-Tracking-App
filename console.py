...
goal1 = Goal("Scotland", "Arrange family trip", 1, "2021-11-12")
goal_repository.save(goal1)
goal2 = Goal("France", "Visit Disneyland", 1, "2021-9-12")
...
milestone_1 = Milestone("Do some research on opening times", "Contact spa and confirm times it is open and hotel availability.", 1, "2021-7-12", goal3)
